...
public class Test6_15 {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 201; i++) {
            System.out.print(50 * i + 49950);
            System.out.print("\t" + Math.round(computeTax(0, 50 * i + 49950)));
            System.out.print("\t\t" + Math.round(computeTax(1, 50 * i + 49950)));
            System.out.print("\t\t" + Math.round(computeTax(2, 50 * i + 49950)));
            System.out.print("\t\t" + Math.round(computeTax(3, 50 * i + 49950)) + "\n");
        }
    }
    ...
    public static double computeTax(int status, double income) {
        ...
        if (status == 0) {   // Compute tax for single filers
            ...
            if (income <= 8350)
                ...
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 +
                        (68525 - 33950) * 0.25 + (208850 - 68525) * 0.28 +
                        (income - 208850) * 0.33;
            else
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 +
                        (68525 - 33950) * 0.25 + (208850 - 68525) * 0.28 +
